...
%%%%%%%%% TITLE
\title{Project Report : Use Object Detection and LLM Prompting on Food Images}

\author{Joe Granados\\
Georgia Tech\\
{\tt\small joe.granados@gatech.edu}
...
Peter Park\\
Georgia Tech\\
{\tt\small ppark46@gatech.edu}
\and
Praveen Ravishankar\\
Georgia Tech\\
{\tt\small pravishankar6@gatech.edu}
\and
Scott Schmidl\\
Georgia Tech\\
{\tt\small sschmidl3@gatech.edu}
}
...
%%%%%%%%% ABSTRACT
\begin{abstract}
In this report, we utilized OpenImagesV5 to study the affects of fine tuning object detection algorithms, followed by prompting a LLM to get nutrition facts, health benefits, and recipes. We implement EfficientNet, YOLO, DETR, and Faster-RCNN. Each model required loading of images in a different way. Our preliminary results showed that Faster-RCNN had a high rate of success.
\end{abstract}
