...
class Food101:
    ...
    def getTrainingAndValidationData(self):
        ...
        data = torchvision.datasets.Food101(root=self.root, split='train', download=True, transform=transformer)
    ...
    def getTestData(self):
        test_data = torchvision.datasets.Food101(root=self.root, split='test', download=True)
