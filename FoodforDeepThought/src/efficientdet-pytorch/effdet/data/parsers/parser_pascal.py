...
from .parser_config import PascalParserCfg


class PascalParser(Parser):

    DEFAULT_CLASSES = (
        'hot dog', 'french fries', 'waffle', 'pancake', 'burrito', 'pretzel', 'popcorn', 'cookie', 'muffin',
        'ice cream', 'cake', 'candy', 'guacamole', 'apple', 'grape', 'common fig', 'pear', 'strawberry', 'tomato',
        'lemon', 'banana', 'orange', 'peach', 'mango', 'pineapple', 'grapefruit', 'pomegranate', 'watermelon',
        'cantaloupe', 'egg (food)', 'bagel', 'bread', 'doughnut', 'croissant', 'tart', 'mushroom', 'pasta', 'pizza',
        'squid', 'oyster', 'lobster', 'shrimp', 'crab', 'taco', 'cooking spray', 'cucumber', 'radish', 'artichoke',
        'potato', 'garden asparagus', 'pumpkin', 'zucchini', 'cabbage', 'carrot', 'salad', 'broccoli', 'bell pepper',
        'winter melon', 'honeycomb', 'hamburger', 'submarine sandwich', 'cheese', 'milk', 'sushi'
    )

    def __init__(self, cfg: PascalParserCfg):
        super().__init__(
